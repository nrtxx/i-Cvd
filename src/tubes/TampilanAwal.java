...
public class TampilanAwal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnStart.setText("Lets Get Started");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tubes/Logo.png"))); // NOI18N
        ...
        jPanel1.setBounds(0, 36, 620, 560);
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        ...
        // lanjut ke halaman menu
        Menu mn = new Menu();
        mn.setVisible(true);
        mn.pack();
        mn.setLocationRelativeTo(null);
        mn.setDefaultCloseOperation(TampilanAwal.EXIT_ON_CLOSE);
        this.dispose();
